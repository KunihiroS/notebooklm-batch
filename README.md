...
> **Prerequisites**: Complete installation and authentication first, you need some works at the first time such as NotebookLM login and some more. — check otu the details in [INSTALL.md](INSTALL.md).
